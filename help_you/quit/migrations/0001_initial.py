    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(blank=True, choices=[('W', 'Женщина'), ('M', 'Мужчина')], default=None, max_length=10, verbose_name='Пол')),
                ...
                ('bad_habits', models.ManyToManyField(to='quit.badhabits', verbose_name='Плохие привычки')),
